...
const getContact = (requester_id, subdomain, options) => {
	return new Promise(function (resolve, reject) {
		const url2 = `https://spritlesoftware.freshdesk.com/api/v2/contacts/26010904307`
...
const getAgent = (requester_id, apikey, subdomain) => {
	return new Promise(function (resolve, reject) {
		...
		axios
			...
			.then((data2) => {
				getContact(requester_id, subdomain, options)
					.then((data) => {
						resolve("Success")
					})
					.catch((error) => {
