...
const displayTickets = (companyData) => {
	...
	for (let i = 0; i < companyData.data.results.length; i++) {
        ...
        <div class="col-sm-6">
        <h2><b>Subject</b> : ${companyData.data.results[i].subject}</h2><br/>
        <h4><b>Description Text</b> : ${companyData.data.results[i].description_text}</h4><br/>
        <p><b>Ticket ID </b>: ${companyData.data.results[i].id}&nbsp &nbsp &nbsp<b>Requester ID </b>: ${companyData.data.results[i].requester_id}&nbsp &nbsp &nbsp<b>Status</b> : ${status_check}&nbsp &nbsp &nbsp<b>Type </b>: ${companyData.data.results[i].type}</p>
        </div>
        </div>
      </div>`
	}
